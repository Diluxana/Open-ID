...
public class AppRestController {
    ...
    public RedirectView processForm1() {
        ...
        String url = "https://diluxana.au.auth0.com/authorize"+
                    "?audience=https://diluxana.au.auth0.com/api/v2/"+
                    "&scope=openid%20profile"+
                    "&response_type=code"+
                    "&client_id=hYTxSI1dvJYEh6Dolt81vye7DQyA6kG0"+
                    "&redirect_uri=http%3A%2f%2flocalhost%3A9500%2foauth%2faccess"+
                    "&state=123";
    ...
    public String getAuthResponse(String authCode)
    {
        ...
        //OAuth Token URL
        String auth_url = "https://diluxana.au.auth0.com/oauth/token";
        
        //Prepare POST Request Body
        String POST_PARAMS = "grant_type=authorization_code"+
                            "&client_id=hYTxSI1dvJYEh6Dolt81vye7DQyA6kG0"+
                            "&client_secret=rF-sUZuZ4k35t6g6Z0eoBfvKmXVy3Xg6jKjPyetf8BIE_CZcXASWRJ5e_wWiclLc"+
                            "&code="+authCode+
                            "&redirect_uri=http%3A%2f%2flocalhost%3A9500%2foauth%2faccess";
        String authReponse = "";
